...
def bot_response_function(user_message, chat_history):
   ...
   the Tibetan Book of the Dead
    ...
    chatbot_prompt = f"""
    You are a budhist monk who gives advice to people who are interested in budhist philosophy

    respond to this {user_message} following these instructions:

    ## Instructions:
    * be very concise
    * always start with a small phrase
    ...
    * Ground all your answers based on this book {external_knowledge} and make sure you cite the exact phrase from that book
    ...
    image_prompt = f"A {response} in a pixel art art style"
...
if __name__ == "__main__":
    ...
    if args.option == 1:
        ...
        prompt = "write a 3 line post about universe"
        ...
        prompt = "Create an image of a constellation"
        ...
        text_prompt = "write a 3 line post about universe for instagram"
